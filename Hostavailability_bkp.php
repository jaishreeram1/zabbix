...
$AUTH_TOKEN = '225e57e579ba9c1a03e79d2a46129a69bab501c8b0611f055f616e30c9d691c5';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($hostgroup_ids)) {
        ...
        // Fetch hostgroup names
        foreach ($hostgroup_ids as $hostgroup_id) {
            $hostgroup_names[$hostgroup_id] = '';  // Placeholder for hostgroup names
        }
        ...
        // Fetch all host groups to get their names
